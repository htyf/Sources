...
<FORM id=form1 name=form1 action="/Struts2Day01/user/user_login" method=post>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <!-- onlick点击的事件，事件删除掉 -->
                <INPUT id=btn 
                  style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" type=image src="${pageContext.request.contextPath }/images/login_button.gif" name=btn> 
